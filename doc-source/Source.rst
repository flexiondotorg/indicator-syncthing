...
The ``indicator-syncthing`` source code is available on GitHub,
...
The recommended way to build ``indicator-syncthing`` is to use `tox <https://tox.readthedocs.io/en/latest/>`_:
